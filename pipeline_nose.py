...
import os
from mask_nose import create_nose_mask  # פונקציה שיוצרת מסכה
from change_nose import change_nose    # פונקציה שמשנה את האף
...
def process_single_image_nose(image_path):
    ...
    create_nose_mask(image_path, mask_output_path)
    ...
    print("Changing nose...")
    change_nose(image_path, mask_output_path, edited_output_path)
